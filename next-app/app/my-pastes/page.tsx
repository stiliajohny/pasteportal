          ...
          {pastes.map((paste) => (
            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-start gap-3">
                  ...
                  <div className="flex flex-wrap items-start gap-2 mb-2">
                    ...
                    {paste.is_password_encrypted && (
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* Password Options - Next to Password Protected Badge */}
                        {paste.password && (
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <div className="flex-1 min-w-0 relative max-w-xs">
                              <code className="block w-full bg-background/60 border border-yellow-500/30 px-2.5 py-1.5 rounded font-mono text-xs text-text break-all pr-12">
                            ...
                            <button
                              ...
                              className="px-2.5 py-1.5 text-xs bg-yellow-500/20 text-yellow-400 rounded hover:bg-yellow-500/30 transition-colors border border-yellow-500/40 font-medium whitespace-nowrap flex items-center gap-1"
                            ...
                            <button
                              ...
                              className="px-2.5 py-1.5 text-xs bg-yellow-500 text-black rounded hover:opacity-90 transition-opacity font-semibold whitespace-nowrap flex items-center gap-1"
                              title="Copy password"
                            >
                ...
                <div className="flex flex-row sm:flex-row items-center gap-2 flex-shrink-0 lg:ml-4">
                  <button
